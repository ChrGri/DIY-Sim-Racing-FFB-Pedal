...
const int32_t tuned_parameters[ISV57_NMB_OF_REGISTERS] = {
    ...
    110,  // Pr0.04: Ratio of inertia. Identified via Stepperonline App (on 26th
          // March 2026)
    0,    // Pr0.05: Command pulse input selection
    0,    // Pr0.06: Motor rotational direction setup
    3,    // Pr0.07: Reserved parameters
    3200, // Pr0.08: Microstep (3200 steps/rev: 213.3 kHz @ 4000 RPM, 800
          // steps/pole pair)
    ...
    0x101,  // 0x8181,  // Pr4.10: Output selection SO1 81: No ALARM ==> 2.4Ohm,
            // ALARM ==> inf Ohm.    Connect A: NO. Connect B: NC
