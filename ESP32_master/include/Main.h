...
#define CORE_ID_HID_TX_TASK (uint8_t)0
#define CORE_ID_HID_RX_TASK (uint8_t)0
...
#define REPETITION_INTERVAL_HID_TX_TASK (int64_t)2000
#define REPETITION_INTERVAL_HID_RX_TASK (int64_t)2000
...
#define TASK_PRIORITY_HID_TX_TASK (UBaseType_t) 1
#define TASK_PRIORITY_HID_RX_TASK (UBaseType_t) 1
...
#define STACK_SIZE_HID_TX_TASK (int64_t) 5000
#define STACK_SIZE_HID_RX_TASK (int64_t) 5000  
