...
set destination=..\TestBuild\Bridge\Fanatec_Bridge\
...
set destination=..\TestBuild\Bridge\Gilphilbert_dongle\
...
set destination=..\TestBuild\Bridge\dev_kit\
...
set destination=..\TestBuild\Bridge\dev_kit_with_external_joystick\
...
set destination=..\TestBuild\Bridge\dev_kit_with_lower_power\
